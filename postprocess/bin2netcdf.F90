...
!---------------------------------------------------------------------
      ...
      read(11) f_tlsun  (:,:)   ! sunlit leaf temperature [K]
      ...
      read(11) f_z0ma   (:,:)   ! effective roughness [m]
...
!---------------------------------------------------------------------
   ...
   SUBROUTINE writenetcdf
      ...
      integer  :: ncid, xid, yid, varid, slevid, sslevid, lakelevid, bandid
      integer  :: lake_lev(nl_lake), slev(nl_soil), sslev(nl_soil-maxsnl), band(2)
    ...
    ! dimensions
      ...
      call sanity( nf90_def_dim(ncid, 'soil_lev',      nl_soil,        slevid) )
    ...
    ! dimension variables
      ...
      call sanity( nf90_def_var(ncid, 'soil_lev', nf90_int, (/slevid/), varid) )
      call sanity( nf90_put_att(ncid, varid, 'long_name',"soil level") )
      ...
      call sanity( nf90_put_att(ncid, varid, 'missing_value', spval_r8) )
      call sanity( nf90_put_att(ncid, varid, '_FillValue', spval_r8) )
      ...
      ! interception [mm/s]
      call sanity( nf90_def_var(ncid, 'f_qintr', nf90_double, (/xid,yid/), varid) )
      ...
      ! infiltration [mm/s]
      call sanity( nf90_def_var(ncid, 'f_qinfl', nf90_double, (/xid,yid/), varid) )
      call sanity( nf90_put_att(ncid, varid, 'long_name','infiltration [mm/s]') )
      call sanity( nf90_put_att(ncid, varid, 'units','mm/s') )
      call sanity( nf90_put_att(ncid, varid, 'missing_value', spval_r8) )
      call sanity( nf90_put_att(ncid, varid, '_FillValue', spval_r8) )      

      ! throughfall [mm/s]
      call sanity( nf90_def_var(ncid, 'f_qdrip', nf90_double, (/xid,yid/), varid) )
      call sanity( nf90_put_att(ncid, varid, 'long_name','throughfall [mm/s]') )
      call sanity( nf90_put_att(ncid, varid, 'units','mm/s') )
      call sanity( nf90_put_att(ncid, varid, 'missing_value', spval_r8) )
      call sanity( nf90_put_att(ncid, varid, '_FillValue', spval_r8) )
      ...
      call sanity( nf90_def_var(ncid, 'f_tlsun', nf90_double, (/xid,yid/), varid) )
      ...
      call sanity( nf90_def_var(ncid, 'f_tlsha', nf90_double, (/xid,yid/), varid) )
      ...
      call sanity( nf90_def_var(ncid, 'f_z0ma', nf90_double, (/xid,yid/), varid) )
      ...
      call sanity( nf90_def_var(ncid, 'f_h2osoi', nf90_double, (/xid,yid,slevid/), varid) )
      call sanity( nf90_put_att(ncid, varid, 'long_name','volumetric soil water in layers [m3/m3]') )
      ...
      call sanity( nf90_def_var(ncid, 'f_zwt', nf90_double, (/xid,yid/), varid) )
    ...
    ! dimension data
      ...
      call sanity( nf90_inq_varid(ncid,'soil_lev',varid) )
      call sanity( nf90_put_var(ncid,varid,slev) )
      ...
      ! interception [mm/s]
      call sanity( nf90_inq_varid(ncid,'f_qintr',varid) )
      call sanity( nf90_put_var(ncid,varid,f_qintr) )

      ! inflitration [mm/s]
      call sanity( nf90_inq_varid(ncid,'f_qinfl',varid) )
      call sanity( nf90_put_var(ncid,varid,f_qinfl) )

      ! throughfall [mm/s]
      call sanity( nf90_inq_varid(ncid,'f_qdrip',varid) )
      call sanity( nf90_put_var(ncid,varid,f_qdrip) )
...
!---------------------------------------------------------------------
      ...
      ! sunlit leaf temperature [K]
      call sanity( nf90_inq_varid(ncid,'f_tlsun',varid) )
      call sanity( nf90_put_var(ncid,varid,f_tlsun) )
      ...
      ! effective roughness [m]
      call sanity( nf90_inq_varid(ncid,'f_z0ma',varid) )
      call sanity( nf90_put_var(ncid,varid,f_z0ma) )
...
!---------------------------------------------------------------------
      ...
      call sanity( nf90_inq_varid(ncid,'f_h2osoi',varid) )
      call sanity( nf90_put_var(ncid,varid,tmp2) )

      ! the depth to water table [m]
      call sanity( nf90_inq_varid(ncid,'f_zwt',varid) )
      call sanity( nf90_put_var(ncid,varid,f_zwt) )
   ...
   SUBROUTINE writenetcdf_ncar
    ...
    ! dimension data
      ...
      where (vars /= spval) vars = hvap * vars
      ! canopy transpiration [W/m2]
      call sanity( nf90_inq_varid(ncid,'FCTR',varid) )
      call sanity( nf90_put_var(ncid,varid,vars) )
      
      tmp0 = spval
      where (f_fevpl /= spval_r8) tmp0 = f_fevpl - f_etr
      ...
      tmp0 = spval
      where (f_sabvsun /= spval_r8) tmp0 = f_sabvsun + f_sabvsha
      ...
      tmp0 = spval
      where (f_olrg /= spval_r8) tmp0 = f_olrg - f_xy_frl
      ...
      tmp0 = spval
      where (f_rnof /= spval_r8) tmp0 = f_rnof - f_rsur
      ...
      tmp0 = spval
      where (f_assim /= spval_r8) tmp0 = f_assim * 1.e6_r8
...
!---------------------------------------------------------------------
      ...
      vars(1:max(lon_points/2,1),:) = f_tlsun((lon_points/2+1):lon_points,:)
      vars((lon_points/2+1):lon_points,:) = f_tlsun(1:max(lon_points/2,1),:)
      vars = vars(:,lat_points:1:-1)
      ! sunlit leaf temperature [K]
      ...
      do i = maxsnl+1, -1
         where (f_wliq_soisno(i,:,:) /= spval_r8) tmp0 = tmp0 + f_wliq_soisno(i,:,:)
      end do
      ...
      do i = maxsnl+1, -1
         where (f_wice_soisno(i,:,:) /= spval_r8) tmp0 = tmp0 + f_wice_soisno(i,:,:)
      end do
      ...
      vars(1:max(lon_points/2,1),:) = f_z0ma((lon_points/2+1):lon_points,:)
      vars((lon_points/2+1):lon_points,:) = f_z0ma(1:max(lon_points/2,1),:)
      vars = vars(:,lat_points:1:-1)
      ! effective roughness [m]
...
!---------------------------------------------------------------------
      ...
      tmp0 = spval
      where (f_sr /= spval_r8) tmp0 = f_xy_solarin - f_sr
