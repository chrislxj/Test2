...
! edgen,edgee,edges,edgew must be the location of grid edges except for the 
! single point when the four varibales represent the center location.
!
...
IMPLICIT NONE
      ...
      real(r8),allocatable :: lats(:)  ! grid cell latitude, southern edge (deg)
      ...
      real(r8),allocatable :: sins(:)  ! grid cell latitude, southern edge(sin)
      ...
      real(r8) :: sins_i(nlat)             ! fine grid cell latitude, southern edge(sin)
      ...
      integer,allocatable :: READ_row_UB(:)  ! north boundary index of a gridcell in fine grids
      integer,allocatable :: READ_col_UB(:)  ! west boundary index of a gridcell in fine grids
      integer,allocatable :: READ_row_LB(:)  ! south boundary index of a gridcell in fine grids
      integer,allocatable :: READ_col_LB(:)  ! east boundary index of a gridcell in fine grids
...
! ................................................................
      ...
      CALL aggregation_landwaters( dir_rawdata,dir_model_landdata, &
                           lon_points,lat_points, &
                           nrow_start,nrow_end,ncol_start,ncol_end, &
                           nx_fine_gridcell,ny_fine_gridcell,area_fine_gridcell,&
                           sinn,sins,lonw_rad,lone_rad,sinn_i,sins_i,lonw_rad_i,lone_rad_i,&
      ...
      CALL aggregation_wetland( dir_rawdata,dir_model_landdata, &
                           lon_points,lat_points, &
                           nrow_start,nrow_end,ncol_start,ncol_end, &
                           nx_fine_gridcell,ny_fine_gridcell,area_fine_gridcell,&
                           sinn,sins,lonw_rad,lone_rad,sinn_i,sins_i,lonw_rad_i,lone_rad_i,&
