...
!         call abort
  ...
  function find_min_area(edgee_rad_coarse_gridcell,edgew_rad_coarse_gridcell,edgee_rad_fine_gridcell, & 
                         ...
                         edgen_sin_fine_gridcell,edges_sin_fine_gridcell,isfirst)
!-------------------------------------------------------------------------------
...
!-------------------------------------------------------------------------------
  ...
  integer,  intent(in) :: isfirst                    ! whether this is the first longitude point for a model grid
...
! -------------------------------------------------------------------------------
     ...
     if(isfirst == 1) then
        dx = min(min(diff_lon1,diff_lon2),diff_lon3)
     else
        if(edgee_rad_coarse_gridcell < edgew_rad_fine_gridcell) then
           diff_lon4 = diff_lon4 + 2 * pi
        endif
        dx = min(min(diff_lon1,diff_lon2),diff_lon4)
     endif
