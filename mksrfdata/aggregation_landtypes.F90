...
!$OMP PRIVATE(i,j,i1,i2,j1,j2,nrow,ncol,ncol_mod,L,isfirst) &
...
#endif
      do j = 1, lat_points
!----------------------modified by zsg, corrected by Nan Wei------------------------------
         ...
         do i = 1, lon_points
            ...
            do nrow = j1, j2
               ...
               do ncol = i1, i2
                  ...
                  !-------find out the overlap between the fine and coarse grid for area weighting--------  
