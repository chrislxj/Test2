...
!-------------------------------------------------------------------------------
! The volumetric fractions of soil solids
!
! Yongjiu Dai, January, 2018
!-------------------------------------------------------------------------------
use precision
...
!-----------------------------------------------------------------------
      ...
      vf_pores_gravels = 0.15            !Parajuli et al. (2020), Stone Content Influence on Land Surface Model 
                                         !Simulation of Soil Moisture and Evapotranspiration at Reynolds Creek Watershed
...
! Mass fraction of gravels
      ...
      if(wf_gravels_s > 1.0) print*,"weinan1"
...
! POROSITY OF SOIL
      ...
      if(vf_pores_s <= 0.0) print*,"weinan2"

! Update Volumetric fraction of all soil contents by weinan
!      a = vf_gravels_s + vf_om_s + vf_sand_s + vf_clay_s + vf_silt_s + vf_pores_s
!      vf_gravels_s = min(vf_gravels_s/a,0.9)      !adjust for k_s
!      vf_om_s      = vf_om_s/a
!      vf_sand_s    = vf_sand_s/a
!      vf_clay_s    = vf_clay_s/a
!      vf_silt_s    = vf_silt_s/a
!      vf_pores_s   = 1.0 - vf_gravels_s - vf_om_s - vf_sand_s - vf_clay_s - vf_silt_s
!      BD_ave = (1.0-vf_gravels_s)*BD + vf_gravels_s*BD_gravels     
...
! Bulk density of mineral soil
      ...
      if(BD_mineral_s > 2.85) print*,"weinan4" 
