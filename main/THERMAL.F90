#include <define.h>
 ...
 SUBROUTINE THERMAL (itypwat     ,lb          ,nl_soil     ,deltim     ,&
                     ...
                     wf_sand     ,porsl       ,psi0        ,bsw        ,&
                     csol        ,k_solids    ,dksatu      ,dksatf     ,&
                     dkdry       ,lai         ,laisun      ,laisha     ,&
                     ...
                     zol         ,rib         ,ustar       ,qstar      ,&
                     tstar       ,fm          ,fh          ,fq         ,&
                     ipatch      ,pg_rain     ,pg_snow     ,t_precip   ,&
...
! Modified by Nan Wei, 07/21/2017, interactions btw prec and canopy/land surface 
      ...
      if(sigf >= 0.001) then
         ...
         if(fsun.le.0.1)then
            ...
            call leaftemone (deltim     ,csoilc  ,dewmx     ,htvp        ,&
                 ...
                 fq         ,qintr_rain ,qintr_snow         ,t_precip,   hprl)
...
!=======================================================================
      ...
      call groundtem (itypwat,lb,nl_soil,deltim,&
                      ...
                      porsl,psi0,bsw,csol,k_solids,dksatu,dksatf,dkdry,&
                      sigf,dz_soisno,z_soisno,zi_soisno,&
...
!=======================================================================
      ...
      errore = sabv + sabg + frl - olrg - fsena - lfevpa - xmf + hprl + & 
             cpliq * pg_rain * (t_precip - t_soisno(lb)) + cpice * pg_snow * (t_precip - t_soisno(lb))
      do j = lb, nl_soil
