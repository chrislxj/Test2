...
! CLM MODEL DRIVER
!
! Original author : Yongjiu Dai, 09/30/1999; 08/30/2002, 03/2014, 05/2018
!
!=======================================================================
...
!$OMP SCHEDULE(STATIC, 1)
      ...
      DO i = 1, numpatch
       ...
       ! SOIL INFORMATION AND LAKE DEPTH
         ...
         bsw(1:,i),       hksati(1:,i),    csol(1:,i),      k_solids(1:,i),  &
         dksatu(1:,i),    dksatf(1:,i),    dkdry(1:,i),     rootfr(1:,i),    &
       ...
       ! LAND SURFACE VARIABLES REQUIRED FOR RESTART
         ...
         zwt(i),          wa(i),                                             &
         t_lake(1:,i),    lake_icefrac(1:,i),  savedtke1(i),                 & ! new lake scheme
