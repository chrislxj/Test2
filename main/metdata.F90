...
CONTAINS
 ...
 ! ------------------------------------------------------------
   SUBROUTINE metreadpoint(forcn)
      ...
      real(r8) :: es, esdT, qsat_tmp, dqsat_tmpdT !weinan
      ...
      call qsadv(forcn(1,1,1),forcn(1,1,3),es,esdT,qsat_tmp,dqsat_tmpdT)  !weinan
      if (qsat_tmp < forcn(1,1,2)) then                                   !weinan
         forcn(1,1,2) = qsat_tmp                                          !weinan 
      endif                                                               !weinan
